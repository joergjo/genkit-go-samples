module github.com/joergjo/genkit-go-samples/rag-server
...
require (
	...
	github.com/weaviate/weaviate v1.33.0 // indirect
	github.com/weaviate/weaviate-go-client/v5 v5.1.0 // indirect
